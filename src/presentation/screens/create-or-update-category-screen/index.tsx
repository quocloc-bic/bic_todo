...
import Button from '@bic_todo/presentation/components/shared/button';
import { useCreateOrUpdateCategoryScreen } from '@bic_todo/adapters/create-or-update-category';
...
const CreateOrUpdateCategoryScreen = () => {
  ...
  const adapter = useCreateOrUpdateCategoryScreen();
